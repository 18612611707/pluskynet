 ...
 */
	...
	public void getDocList() {
		...
		list = latitudeauditService.getDocList(causename,latitudetype,num,this.getRows(),this.getPage(),ruleid);
		int size = latitudeauditService.getDocby(causename,latitudetype,num,ruleid);
		outJsonByPage(list, size, "成功", "");
		}
	}
	public void getDoc(){
		String htmlString = latitudeauditService.getDoc(causename,latitudetype,docid,ruleid);
